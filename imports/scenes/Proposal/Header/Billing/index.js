...
export default class Billing extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      billingProducts: this.props.proposal.billingProducts || [],
      billingServices: this.props.proposal.billingServices || [],

      inss: this.props.proposal.inss === undefined ? 11 : this.props.proposal.inss,
      iss: this.props.proposal.iss === undefined ? 5 : this.props.proposal.iss,
    ...
    var duration = this.props.proposal.dates.timeUnit === "months" ? this.props.proposal.dates.duration : 1;
    var containers = this.props.proposal.containers;
    var accessories = this.props.proposal.accessories || [];
    var services = this.props.proposal.services || [];
    var discount = this.props.proposal.discount;
