...
class Configuration extends React.Component {
  ...
  restoreImages = () => {
    this.setState({ databaseStatus: "loading" });
    Meteor.call("aws.restore.deleted.files", (err, res) => {
      if (err) {
    ...
    return (
      <div className="page-content">
        ...
        <div className="main-scene configuration">
          <MainHeader title="Configurações" type="configuration" />
          <div className="main-scene__body configuration__body">
            ...
            <Input
              ...
              onChange={this.onChangeProposalConditions}
            />
            <button className="button--pill" onClick={this.restoreImages}>
              RESTAURAR IMAGENS
            </button>
            <FooterButtons
              buttons={[{ text: "Salvar Alterações", onClick: this.saveEdits }]}
            />
          </div>
