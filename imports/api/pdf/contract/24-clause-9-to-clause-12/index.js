export default function (props) {
  ...
  return [
    {text: `CLÁUSULA NONA - DA DEVOLUÇÃO DO OBJETO DE LOCAÇÃO`, style: 'h2'},
    ...
    {text: `§ 2º. O não atendimento dessas providências facultará à LOCADORA aceitar ou não a devolução dos equipamentos até que sejam atendidas, assim como a cobrança extra de eventuais períodos de locação, serviços, visitas técnicas, viagens e demais despesas geradas pelo ocorrido.`, style: 'p'},
    ...
    {text: `CLÁUSULA DÉCIMA - DA VEDAÇÃO À SUBLOCAÇÃO, À CESSÃO DE LOCAÇÃO E AO EMPRÉSTIMO A TERCEIROS`, style: 'h2'},
    ...
    {text: `CLÁUSULA DÉCIMA SEGUNDA - DO FORO`, style: 'h2'},
