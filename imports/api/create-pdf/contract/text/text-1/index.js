export default function (proposal) {
  return [
    {text: `que declara estar investido dos poderes necessários para contratar em nome da LOCATÁRIA, assumindo inclusive a qualidade de fiel depositário do Objeto da Locação descrito abaixo, assim como a contratação dos serviços associados, e estabelecem entre si o presente Contrato de Locação de Bens Móveis e Prestação de Serviços oriundo da proposta aprovada de número ${proposal} e regido pelas cláusulas e condições a seguir:`, style: 'p'},
