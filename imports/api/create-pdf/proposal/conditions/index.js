...
export default function conditions (props) {
  ...
  return [
    ...
    {ul: [
      ...
      conditionalLine1(),
      conditionalLine2(),
      'Atenção: em caso de adiamento por parte do cliente da props de entrega, será considerada a props programada inicialmente para faturamento, visto que os itens ficam reservados para o cliente e indisponíveis para outras locações.',
