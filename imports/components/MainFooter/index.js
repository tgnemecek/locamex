...
export default class MainFooter extends React.Component {
  ...
  toggleActivateWindow = () => {
    ...
    const isBillingCorrect = () => {
      if (this.props.type === "proposal") return true;
  ...
  renderButtons = () => {
    if (this.props.status === 'inactive') {
      var activeText = this.props.type === "contract" ? "Ativar Contrato" : "Fechar Proposta";
      return (
    ...
    } else if (this.props.status === 'active' && this.props.type === "contract") {
      return (
        <FooterButtons buttons={[
    ...
    return (
      <div className="scene-footer">
        ...
        <ConfirmationWindow
          ...
          closeBox={this.toggleWindowsOff}
          message={this.props.type === "contract" ? "Deseja ativar este contrato?"
