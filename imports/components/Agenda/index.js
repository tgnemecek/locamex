...
export default AgendaWrapper = withTracker((props) => {
  ...
  var contractsDatabase = Contracts.find({
  ...
  contractsDatabase.forEach((contract) => {
    ...
    var productsEvents = getBillEvents(
      snapshot, 'billingProducts', contract);
    var servicesEvents = getBillEvents(
      snapshot, 'billingServices', contract);
