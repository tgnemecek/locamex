...
class RegisterSeries extends React.Component {
  ...
  onChangeContainer = (e) => {
    ...
    var container =
      this.props.containersDatabase.find((container) => {
  ...
  onChangePlace = (e) => {
    var _id = e.target.value;
    var place =
      this.props.placesDatabase.find((place) => {
    ...
    return (
      ...
      >
        <Block columns={3} options={[{ block: 3, span: 3 }]}>
          ...
          >
            <option value="">
              {this.props.item && this.props.item.rented ? "Alugado" : ""}
            </option>
            {this.renderPlaces()}
          </Input>
          <Input
        ...
        <FooterButtons
          ...
          buttons={
            this.props.item._id && tools.isWriteAllowed("series")
              ? [
                  {
                    text: "Excluir Registro",
                    className: "button--danger",
                    onClick: () =>
                      this.props.toggleConfirmationWindow(this.hideSeries),
                  },
                  {
                    text: "Voltar",
