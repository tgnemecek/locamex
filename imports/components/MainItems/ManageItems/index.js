...
export default class ManageItems extends React.Component {
  ...
  filterDatabase = () => {
    function compare(inputValue, dbValue) {
      inputValue = tools
        .removeSpecialChars(inputValue, /[\.\/\-\(\) ]/g)
        .toUpperCase();
      dbValue = tools
        .removeSpecialChars(dbValue, /[\.\/\-\(\) ]/g)
        .toUpperCase();
    ...
    return (
      ...
      >
        <div className="manage-items__body">
          <div>
            <div className="manage-items__subtitle">Banco de Dados:</div>
            <FilterBar
          ...
          <Database database={this.filterDatabase()} addItem={this.addItem} />
          <AddedItems
